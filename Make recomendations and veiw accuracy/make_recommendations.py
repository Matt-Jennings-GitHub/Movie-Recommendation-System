...
recommended_df = movies_df[movies_df.index.isin(already_reviewed) == False] # Find if not in list
recommended_df = recommended_df.sort_values(by=['rating'], ascending=False) # Highest ratings first
